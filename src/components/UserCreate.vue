<template>
  <div class="block px-20 py-6 max-w-sm bg-gradient-to-r from-[#9FBACD] to-[#F2C144] rounded-lg border border-gray-200 shadow-md mb-10">
    <h2 class="mb-2 text-2xl font-bold tracking-tight text-slate-100">Alors chaud 😗 ?</h2>
    <form @submit.prevent="onSubmit">
      ...
      <div class="form-group mt-3">
        ...
        <div class="flex">
          ...
          <p class="ml-2 text-slate-100">Let's go 🍾</p>
        </div>
        <div class="flex">
          <input type="checkbox" v-model="form.notAvailable">
          <p class="ml-2 text-slate-100">Non 🥴</p>
        </div>
      </div>
